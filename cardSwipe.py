...
while cardNum != "quit":						                      # asks for input reaptedly
	if cardNum in accessList:				                      	# checks if input number is in accessList
		subprocess.call("/home/jacob/Documents/ENGE1104/Group Project/relayON.sh")	 # turns the relay on
		time.sleep(6)																                                 # waits a few seconds to let them open the door
		subprocess.call("/home/jacob/Documents/ENGE1104/Group Project/relayOFF.sh")  # turns the relay off
	else:
